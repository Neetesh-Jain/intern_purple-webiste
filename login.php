...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (isset($_POST["admin_login"])) {
        ...
        // Prepare SQL query to get admin details based on email
        ...
        if (mysqli_stmt_prepare($stmt, $sql)) {
            ...
            if (!$admins) {
                ...
                // Debug: Log stored password in plain text
                error_log("Stored password (plain text) from database: " . $admins["password"]);
                
                // Compare the plain text password directly
                if ($password === $admins["password"]) {
                    echo "<div class='alert alert-success'>Password verification succeeded. Redirecting...</div>";
    
                    // Set session variables upon successful login
                    $_SESSION["admin"] = $admins["id"];
                    $_SESSION["role"] = 'admin';
            ...
            echo "<div class='alert alert-danger'>An error occurred: " . mysqli_error($conn) . "</div>";
        }
    }
...
<div class="admin-login-form" style="display: none;">
    ...
    <form action="login.php" method="POST">
        ...
        <p class="toggle-form">Go back to <span id="switch-to-user-login" onclick="window.location.href='login.php'">User Login</span></p>
    </form>
</div>
        ...
        <div class="register-form" style="display: none;">
            ...
            <form action="" method="POST">
                ...
                <p class="toggle-form">Already have an account? <span id="switch-to-user-login" onclick="window.location.href='login.php'">User Login</span>
