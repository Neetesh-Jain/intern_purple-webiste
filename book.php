            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="order-summary">
                        ...
                        <p class="total-price"><strong>Total:</strong></p>
                        <!-- Checkout Button -->
...
<div class="container mt-5" id="booking1" style="display:none;">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <form id="bookingForm" action="submit_order.php" method="POST">
                ...
                <!-- Submit Button Below the "Proceed to Pay" Button -->
                <button type="button" id="proceedToPayButton" class="btn btn-success mt-3">Proceed to Pay</button>
...
document.getElementById("proceedToPayButton").onclick = function () {
    ...
    // Array of available image filenames
    const productImages = [
        'product_1.png', 'product_2.png', 'product_3.png', 'product_4.png',
        'product_5.png', 'product_6.png', 'product_7.png', 'product_8.png',
        'product_9.png', 'product_10.png', 'product_11.png', 'product_12.png',
        'single_1_thumb.jpg', 'single_1.jpg', 'single_2_thumb.jpg', 'single_2.jpg',
        'single_3_thumb.jpg', 'single_3.jpg', 'slider_1.jpg', 'slider_2.jpg', 'slider_3.jpg'
    ];
   // Base URL to the images folder
    const basePath = 'http://localhost/purple-website-demo/purple-website/images/';
    savedCartItems.forEach((item, index) => {
        ...
        cartItem.innerHTML = `
            <div class="cart-item-content d-flex">
                <!-- Product Image next to Product Name -->
                <div class="product-image-container">
                    <img src="${basePath + randomImage}" alt="${item.name}" class="cart-item-image" style="width: 100px; height: auto; margin-right: 15px;">
                </div>
...
function removeItem(index) {
    const savedCartItems = JSON.parse(localStorage.getItem("cartItems")) || [];
    savedCartItems.splice(index, 1); // Remove the selected item from the array
...
$(document).ready(function() {
    ...
    function calculateTotalPrice() {
        ...
        var pricePerItem = parseFloat($('#pricePerItem').val()) || 0;
        var totalPrice = quantity * pricePerItem;

        // Update the total price display and hidden input
        $('#totalPrice').val(totalPrice.toFixed(2)); // Update the hidden input
        $('#displayTotalPrice').text(totalPrice.toFixed(2)); // For display purposes
    }

    // Trigger the calculation when relevant fields change
    $('#quantity, #pricePerItem').on('input', function() {
        calculateTotalPrice();
    });
